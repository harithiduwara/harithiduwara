...
\section{Projects}
\resumeSubHeadingListStart
  \resumeSubItem{Credit Card Statement Analyser}
    {A tool that parses credit card statements to categorise transactions and surface spending insights and summaries.}
  \resumeSubItem{WeddingsByHarith.com}
    {A website for wedding photography and videography services. \href{https://weddingsbyharith.com}{weddingsbyharith.com}}
